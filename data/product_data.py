...
backpack = Product(
    ...
    description='Carry all the things with the sleek, streamlined Sly Pack that melds uncompromising style with '
...
light = Product(
    ...
    price='$9.99',
    selector='item_0_title_link'
)

t_shirt_black = Product(
